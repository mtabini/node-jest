...
Client.prototype._performAuth = function(socket) {
  ...
  .fail(function(err) {
    self.emit('authError', err, socket);
...
Client.prototype._failRequest = function(id) {
...
Client.prototype._sendRequest = function(socket, payload, cb) {
  ...
  .then(function(id) {
    ...
    self._requestTimeouts[id] = setTimeout(self._failRequest.bind(self, id), self.timeout);
